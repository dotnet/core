...
| .NET Core 3.0 | [Preview releases](https://github.com/dotnet/core/blob/master/release-notes/3.0/README.md)<br/>Release Candidate scheduled for July 2019<br/>Final Release scheduled for September 2019 |
| .NET Core 3.1 LTS | Release scheduled for November 2019 |
| .NET 5.0 | Release scheduled for November 2020 |
| .NET 6.0 LTS | Release scheduled for November 2021 |
