...
Do NOT use area-label-scoped searches as described in `data-2-collect-prs.md` — those are Libraries-specific.
...
Follow the general format template from `author-2-format.md` with these overrides:
