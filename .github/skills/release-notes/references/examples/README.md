...
15. **Prefer literal transition verbs** — if something moved namespaces or assemblies, say that directly. "Zstandard moved to `System.IO.Compression`" is clearer than "Zstandard joins `System.IO.Compression`."
