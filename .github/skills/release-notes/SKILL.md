...
5. `release-notes` writes curated component markdown using the higher-value entries from `features.json` and creates a reader-facing milestone index using the standard `README.md` structure in [`format-template.md`](references/format-template.md)
