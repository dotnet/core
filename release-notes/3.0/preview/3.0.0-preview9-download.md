...
Please see the [3.0 Supported OS](https://github.com/dotnet/core/blob/main/release-notes/3.0/3.0-supported-os.md) document for specific distribution version support status.
