...
+        public Pkcs8PrivateKeyInfo(Oid algorithmId, Nullable<ReadOnlyMemory<byte>> algorithmParameters, ReadOnlyMemory<byte> privateKey, bool skipCopies = false);
+        public Oid AlgorithmId { get; }
+        public Nullable<ReadOnlyMemory<byte>> AlgorithmParameters { get; }
