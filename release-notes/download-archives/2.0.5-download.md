...
wget -q https://packages.microsoft.com/config/debian/8/prod.list > ./microsoft-prod.list
...
wget -q prod.repo https://packages.microsoft.com/config/opensuse/42.2/prod.repo
