...
Arm32 builds are supported on distro versions with a [Y2038 compatible libc](https://github.com/dotnet/core/discussions/9285), for example Debian 12, Ubuntu 22.04, and higher versions. See Libc compatibility.
