...
#### Usage of incorrect types as DynamicResource
...
#### Incorrect rendering of applications launched with dark theme
...
The implementation for the same would like something like this -
```cs
