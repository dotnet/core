...
+        public JsonUnknownDerivedTypeHandling UnknownDerivedTypeHandling { get; set; }
+        void System.Collections.Generic.ICollection<(System.TypeDerivedType,System.StringTypeDiscriminatorId)>.Add((Type DerivedType, string TypeDiscriminatorId) item);
+        void System.Collections.Generic.ICollection<(System.TypeDerivedType,System.StringTypeDiscriminatorId)>.Clear();
+        bool System.Collections.Generic.ICollection<(System.TypeDerivedType,System.StringTypeDiscriminatorId)>.Contains((Type DerivedType, string TypeDiscriminatorId) item);
+        void System.Collections.Generic.ICollection<(System.TypeDerivedType,System.StringTypeDiscriminatorId)>.CopyTo((Type DerivedType, string TypeDiscriminatorId)[] array, int arrayIndex);
+        bool System.Collections.Generic.ICollection<(System.TypeDerivedType,System.StringTypeDiscriminatorId)>.Remove((Type DerivedType, string TypeDiscriminatorId) item);
+        IEnumerator<(Type DerivedType, string TypeDiscriminatorId)> System.Collections.Generic.IEnumerable<(System.TypeDerivedType,System.StringTypeDiscriminatorId)>.GetEnumerator();
