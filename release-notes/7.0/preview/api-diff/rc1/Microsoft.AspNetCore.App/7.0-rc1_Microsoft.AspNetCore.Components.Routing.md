...
+        [AsyncStateMachineAttribute(typeof(NavigationLock.<Microsoft-AspNetCore-Components-IComponent-SetParametersAsync>d__21))]
+        Task IComponent.SetParametersAsync(ParameterView parameters);
+        [AsyncStateMachineAttribute(typeof(NavigationLock.<System-IAsyncDisposable-DisposeAsync>d__23))]
