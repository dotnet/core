# .NET 7.0.410 - May 28, 2024

The .NET 7.0.410 release is available for download. This SDK includes the previously released .NET 7.0.20 Runtime and is in support of Visual Studio 17.5 release. The latest 7.0 release is always listed at [.NET 7.0 Releases](../README.md).
...
[release-notes]: https://github.com/dotnet/core/blob/main/release-notes/7.0/7.0.20/7.0.410.md
