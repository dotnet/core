...
[.NET 7](README.md) is a [Standard Term Support release](../../release-policies.md) and [is supported](../../microsoft-support.md) on multiple operating systems per their lifecycle policy.
