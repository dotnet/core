...
The .NET 7.0.400-preview.23225.8 release is available for download. This SDK includes the previously released .NET 7.0.5 Runtime and is in support of Visual Studio 17.6 release. The latest 7.0 release is always listed at [.NET 7.0 Releases](../README.md).
