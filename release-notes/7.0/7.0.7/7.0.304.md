# .NET SDK 7.0.304 - June 13, 2023

The .NET 7.0.304 release is available for download. This SDK includes the previously released .NET 7.0.7 Runtime and is in support of Visual Studio 17.6 release. The latest 7.0 release is always listed at [.NET 7.0 Releases](../README.md).
...
[release-notes]: https://github.com/dotnet/core/blob/main/release-notes/7.0/7.0.5/7.0.304.md
