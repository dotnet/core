...
|--------|----------------|----------------|
| llms-index | `llms.json` → `8.0/8.0.21/index.json` | **13 KB** |
...
| Schema | Files Required | Total Transfer |
|--------|----------------|----------------|
| llms-index | `llms.json` → `manifest.json` → `supported-os.json` | **15 KB** |
| hal-index | `index.json` → `10.0/index.json` → `manifest.json` → `supported-os.json` | **35 KB** |
...
| Schema | Files Required | Total Transfer |
|--------|----------------|----------------|
| llms-index | `llms.json` → `manifest.json` → `os-packages.json` + `sdk/index.json` → `downloads/index.json` → `downloads/sdk.json` | **~25 KB** |
