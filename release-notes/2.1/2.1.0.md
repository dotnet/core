...
* .NET Core 2.1 [Deployment of .NET Core 2.1.0 to Azure App Services](https://github.com/Azure/app-service-announcements/issues/XXX) has begun. It will be available in limited regions today and expected worldwide by the end of the week.
