...
### [CVE-2018-xxxx: ASP.NET Core Security Denial of Service Vulnerability](https://github.com/aspnet/Announcements/issues/xxx)

**Executive summary**

Microsoft is releasing this security advisory to provide information about a vulnerability in ASP.NET Core. This advisory also provides guidance on what developers can do to update their applications to remove this vulnerability.

The update addresses the vulnerability by [xxxxx].

#### Package and Binary updates

| Package name | Vulnerable versions | Secure versions |
| :--- | :--- | :--- |
Microsoft.AspNetCore.Identity | 2.1.0, 2.1.1, 2.1.2, 2.1.3 |  |
