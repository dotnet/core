...
**Installer feed changes** There are now specific feeds for Fedora, OpenSUSE and SLES. See the changes detailed on the [download page](https://github.com/dotnet/core/blob/master/release-notes/download-archives/2.1.0-rc1-download.md).
