...
=======
# .NET Core SDK 2.1.400 - Aug 14, 2018
>>>>>>> 5e7d0dd... Made updates for release notes
...
<<<<<<< HEAD
See the [Release Notes](https://github.com/dotnet/core/blob/master/release-notes/2.1/2.1.2.md) for details about what is included in this update.
>>>>>>> 345a3cd... initial 2.1.400 dl doc
=======
See the [Release Notes](https://github.com/dotnet/core/blob/master/release-notes/2.1/2.1.400-SDK/2.1.400-sdk.md) for details about what is included in this update.
>>>>>>> 5e7d0dd... Made updates for release notes
