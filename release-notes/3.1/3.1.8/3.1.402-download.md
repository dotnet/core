...
See the [Release Notes](https://github.com/dotnet/core/blob/master/release-notes/3.1/3.1.8/3.1.8.md) for details about what is included in this update.
...
[release-notes]: https://github.com/dotnet/core/blob/master/release-notes/3.1/3.1.8/3.1.402-download.md
