...
.NET 6 is the next major release of .NET following .NET 5.0. You can see some of the new features available with .NET 6 Preview 4 at [dotnet/core #XXXX](https://github.com/dotnet/core/issues/6295).
