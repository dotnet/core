# .NET 6.0.0 Preview 3 - April 13, 2021

The .NET 6.0.0 Preview 3 and .NET SDK 6.0.100-preview.3.21155.3 releases are available for download. The latest 6.0 release is always listed at [.NET 6.0 Releases](../README.md).

## What's new in .NET 6 Preview 3

.NET 6 is the next major release of .NET following .NET 5.0. You can see some of the new features available with .NET 6 Preview 3 at [dotnet/core #5889](https://github.com/dotnet/core/issues/5889).
