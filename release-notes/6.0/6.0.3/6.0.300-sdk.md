...
The .NET 6.0.300 SDK release is available for download. This SDK includes the previously released .NET 6.0.3 Runtime and is in support of Visual Studio 17.2 GA release. The latest 6.0 release is always listed at [.NET 6.0 Releases](../README.md).
...
Microsoft.DotNet.Common.ProjectTemplates | 6.0.6.0.300-preview.22126.1.nupkg
