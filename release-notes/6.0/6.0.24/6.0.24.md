...
Microsoft is releasing an update to our October 12, 2023 security release. The .NET 6.0.23 updates inadvertently missed (were not cumulative of) the security fixes in our previous September 12, 2023 update. The new .NET 6.0.24 update is cumulative of both September and October security fixes.
