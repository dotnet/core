# .NET 6.0.200 Preview SDK - January 20, 2022

The .NET 6.0.200 Preview SDK release is available for download. This SDK includes the previously released .NET 6.0.1 Runtime and is in support of Visual Studio 17.1 Preview 3 release. The latest 6.0 release is always listed at [.NET 6.0 Releases](../README.md).
