...
The Virtualization component is new in RC1 and there are some fixes we didn't fit in RC1, which make the component unusable for cetain scenarios. All these limitations are going to be resolved in RC2:
