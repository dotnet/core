...
1. .NET 5.0 on Windows 10 May 2019 Update and later versions depends on ICU library for the Globalization:
  ...
  Please read the following docs to see the motivation behind the change, workarounds and more information about how you can encounter this breaks and mitigate them:
    - [.NET globalization and ICU](https://review.docs.microsoft.com/dotnet/standard/globalization-localization/globalization-icu)
    - [Behavior changes when comparing strings on .NET5+](https://review.docs.microsoft.com/dotnet/standard/base-types/string-comparison-net-5-plus)
    - [Globalization breaking changes](https://review.docs.microsoft.com/dotnet/core/compatibility/globalization)
