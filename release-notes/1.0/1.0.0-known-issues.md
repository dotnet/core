...
[Bash on Windows (WSL)](https://msdn.microsoft.com/commandline/wsl/about) is not yet supported by .NET Core. Attempting to run applications in the environment can experience intermittent crashes.
