...
.NET Core SDK 2.2.101 is available for download and usage in your environment. This release includes the previously released .NET Core 2.2.0. The .NET Core SDK 2.2.101 matches what is included in [Visual Studio 2017 version 15.9.4](https://docs.microsoft.com/en-us/visualstudio/releasenotes/vs2017-relnotes#15.9.4).
...
Your feedback is important and appreciated. We've created an issue at [dotnet/core #2133](https://github.com/dotnet/core/issues/2133) for your questions and comments.
...
[release-notes]: https://github.com/dotnet/core/blob/master/release-notes/2.2/2.2.101-SDK/2.2.101.md
