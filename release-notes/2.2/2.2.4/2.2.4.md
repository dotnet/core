...
| :-- | :--: |
| Visual Studio 2017 and Visual Studio for Mac 7.8 | [2.2.106](#downloads) |
| Visual Studio 2019 (Windows and Mac) | [2.2.203](../2.2.203-SDK/2.2.203-SDK-download.md) |
...
We've created an issue at [dotnet/core #2555](https://github.com/dotnet/core/issues/XXXX) for your questions and comments.
