...
An incredible number of APIs have been added to NETStandard2. See [Announcing NETStandard2](https://devblogs.microsoft.com/dotnet/announcing-net-standard-2-0/) for details.
