...
* [`[1bf7752]`](https://github.com/dotnet/cli/commit/1bf7752) Renaming "dotnet-dev" to "dotnet-sdk"; therefore: renaming "dotnet-sdk" to "dotnet-sdk -internal". Pinning the install scripts to an unrenamed version so the build will not break on the 'latest'. Note: This is part 1 of a 2 part change
...
* [`[75eac0c]`](https://github.com/dotnet/cli/commit/75eac0c) Moving version validation to only when a SDK is not overridden. Also adding a validation for the minimum MSBuild version.
...
* [`[1ded4f1]`](https://github.com/dotnet/cli/commit/1ded4f1) Forcing 'curl' to return an usable exit code.
...
* [`[357fd3d]`](https://github.com/dotnet/cli/commit/357fd3d) Fixing restore so that it respects the verbosity param. The problem was that ConsoleLoggerParameters was overwriting whatever was coming through the command line.
...
* [`[c53c6c5]`](https://github.com/dotnet/corefx/commit/c53c6c5) Add tests for invalid requests sent from the client to the http listener (#20233)
