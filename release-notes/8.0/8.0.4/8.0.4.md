...
The .NET 8.0.4 and .NET SDK 8.0.202 releases are available for download. The latest 8.0 release is always listed at [.NET 8.0 Releases](../README.md).
...
A use-after-free vulnerability exists in WCF which may result in Elevation of Privilege when viewing untrusted documents.
