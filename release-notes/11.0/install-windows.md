# .NET 11 installation instructions for Windows

The following instructions demonstrate installing .NET 11 on Windows. These instructions augment the more general [.NET install instructions](install.md), including installing with `.zip` files, that work on multiple operating systems.
...
- To install the .NET 11 runtime: `winget install dotnet-runtime-11`
- To install the .NET 11 SDK: `winget install dotnet-sdk-11`
...
```console
C:\>curl -Lo dotnet.zip https://builds.dotnet.microsoft.com/dotnet/Sdk/11.0.100-preview.2.26159.112/dotnet-sdk-11.0.100-preview.2.26159.112-win-x64.zip
