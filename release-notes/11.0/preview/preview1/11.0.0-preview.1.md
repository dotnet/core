...
.NET 11 is compatible with  [Visual Studio 17.10 latest preview](https://visualstudio.microsoft.com) Users will have to [download](https://dotnet.microsoft.com/download/dotnet/11.0) and install the .NET 11 runtime/sdk standalone. Visual Studio for Mac is currently not supported for .NET 11.0 Preview releases.
