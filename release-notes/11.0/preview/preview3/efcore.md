...
- [It is easier to swap providers and configure pooled factories](#it-is-easier-to-swap-providers-and-configure-pooled-factories)
- [Migrations get more control and clearer feedback](#migrations-get-more-control-and-clearer-feedback)
- [SQL generation and JSON support continue to improve](#sql-generation-and-json-support-continue-to-improve)
...
([dotnet/efcore#37847](https://github.com/dotnet/efcore/pull/37847)). This is a
nice improvement for long-lived contexts or high-volume change-tracking code
where you already know which states you care about.
...
## It is easier to swap providers and configure pooled factories
...
particularly handy in tests, where a production SQL Server configuration often
needs to be replaced with an in-memory or SQLite provider.

`AddPooledDbContextFactory<TContext>()` also now has a parameterless overload,
which removes some boilerplate when configuration already lives in
...
## SQL generation and JSON support continue to improve
